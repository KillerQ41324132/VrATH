...
public class DEMON_D_script : MonoBehaviour
{
    ...
    [SerializeField] private EventReference BushD;
    [SerializeField] private EventReference BushDJump;
    private int stage;
    ...
    void Stage1()
    {
        RuntimeManager.PlayOneShot(BushD, spawnerPosition);//MIJSCE DLA AGNIESI
        Debug.Log("Entered Stage D1");
        // Dodatkowe dzia³ania dla Stage 1
    }
    void Stage2()
    {
        RuntimeManager.PlayOneShot(BushDJump, spawnerPosition);//MIJSCE DLA AGNIESI + MICHASIA UWU
        Debug.Log("Entered Stage D3");
        ...
        if (demonPrefab != null && spawnerPosition != null)
        {
            ...
            demon.layer = LayerMask.NameToLayer("Dint"); //interakcja na jakiej warstwie
        }
